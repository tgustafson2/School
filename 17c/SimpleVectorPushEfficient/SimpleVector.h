...
void SimpleVector<T>::push(T &val){
    double opeq,oplt,opinc,opindex,opmin,opgt,opplus,opeqtest,opdiv,opmul;
    opeq=oplt=opinc=opindex=opmin=opgt=opplus=opeqtest=opdiv=opmul=0;
    opeqtest+=1;
    ...
    cout<<"# of mul operations  = "<<opmul<<endl;
    float optot=opeq+oplt+opinc+opdiv+opindex+opmin+opgt+opplus+opmul;
